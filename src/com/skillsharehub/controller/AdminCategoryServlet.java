    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("edit".equals(action)) {
            ...
            try {
                ...
                if (category == null) {
                    response.sendRedirect(request.getContextPath() + "/pages/admin/categories?edit=notfound");

                    return;
                }

                request.setAttribute("category", category);
                RequestDispatcher dispatcher = request.getRequestDispatcher("/pages/adminCategoryEdit.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("add".equals(action)) {
            ...
            if (categoryName == null
                ...
                response.sendRedirect(request.getContextPath() + "/pages/admin/categories?add=invalid");
            ...
            if (fileName == null || !fileName.toLowerCase().endsWith(".png") || !"image/png".equals(contentType)) {
                response.sendRedirect(request.getContextPath() + "/pages/admin/categories?add=invalid");
            ...
            String savedFileName = System.currentTimeMillis() + "_" + new File(fileName).getName();
            ...
            if (added) {
                response.sendRedirect(request.getContextPath() + "/pages/admin/categories?add=success");
                ...
                response.sendRedirect(request.getContextPath() + "/pages/admin/categories?add=failed");
            }
        ...
        if ("update".equals(action)) {
            ...
            try {
                ...
                String iconFileName = existingCategory.getCategoryIcon();
                /*
                ...
                if (iconPart != null && iconPart.getSize() > 0) {
                    ...
                    String newIconFileName = System.currentTimeMillis() + "_" + new File(originalFileName).getName();

                    String newFilePath = uploadPath + File.separator + newIconFileName;
                ...
                if (updated) {
                    ...
                    if (iconPart != null && iconPart.getSize() > 0
                        ...
                        String oldIconPath = getServletContext().getRealPath("/images/categories/" + existingCategory.getCategoryIcon());
                    ...
                    response.sendRedirect(request.getContextPath() + "/pages/admin/categories?edit=success");
                     ...
                     */
                    if (iconPart != null && iconPart.getSize() > 0
                            && !iconFileName.equals(existingCategory.getCategoryIcon())) {

                        String newIconPath = getServletContext().getRealPath("/images/categories/" + iconFileName);
                    ...
                    response.sendRedirect(request.getContextPath() + "/pages/admin/categories?edit=failed");
                }
